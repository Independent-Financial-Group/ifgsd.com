...
const index = ({ preview, models }) => {
  ...
  return (
    <>
      <Head>
        <title>Portfolio Construction Models</title>
      </Head>
      <PageHeader
          ...
          <GridTile colSpan="col-span-12" tileTitle="Why Use Model Portfolios?">
            <div className=" inline-block min-w-full py-2 align-middle">
              ...
              <div className="mt-5 border-t-2 border-gray-200 pt-2">
                <p>
                  In IFG&apos;s annual advisor survey, the top answer for “What
                  is the greatest roadblock preventing you from getting to the
                  next level?” was Time Management. Model portfolios could be an
                  attractive solution that allows you the flexibility to free up
                  your time so you can spend more time with clients and grow
                  your business.
                </p>
