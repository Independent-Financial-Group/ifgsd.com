          ...
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 relative">
            <div className="mb-10">
              ...
              <p className="text-center mx-auto xl:w-1/2">
                we take pride in the relationships we build with our reps. Don't just take our word for it – hear what our valued reps have to say about their experiences with us.
              </p>
            </div>
            <motion.div
              ...
              className=" flex flex-col gap-y-4 lg:grid lg:grid-cols-3 gap-4 xl:max-w-screen-xl"
            >
