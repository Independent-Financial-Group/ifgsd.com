      ...
      <main>
        <section class="dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
              <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-blue-wave-500 dark:text-seabreeze-500">Fearlessly Independent</h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-10 h-10 text-dunkel-blue-200">
              ...
              <div>
                ...
                <p class="text-dunkel-blue dark:text-gray-400">We partner with a wide range of service providers to help youy run your business more effeciently.</p>
              </div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-10 h-10 text-dunkel-blue-200">
              ...
              <div>
                ...
                <p class="text-dunkel-blue dark:text-gray-400">We offer one of the most competitive payouts in the industry. A great payout offering in addition to the variety of services we offer make it simple to see why our advisors choose to join and stay with us.</p>
              </div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-10 h-10 text-dunkel-blue-200">
        ...
        <section className="bg-dune-500">
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="sm:text-lg dark:text-gray-400 text-dune-900">
            ...
            <div className="relative flex flex-row justify-end">
              <Image
                src='https://new.ifgsd.com/wp-content/uploads/2023/03/Mask-group.png' className='self-end rounded-lg mx'
        ...
        <section class="py-24 sm:py-32">
          <div class="mx-auto w-[90%] lg:max-w-7xl px-6 lg:px-8 bg-white p-8 rounded-md drop-shadow">
            <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-blue-wave-500 text-center">The Rankings</h2>
            <div className="flex flex-col gap-y-5">
              <dl class="grid grid-cols-1 gap-y-16 text-center lg:grid-cols-3 py-3">
                ...
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                  ...
                  <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">$37 Billion</dd>
                </div>
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
              ...
              <dl class="grid grid-cols-1 gap-y-16 text-center lg:grid-cols-3 py-3">
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                  <dt class="text-base leading-7 text-gray-600">Recruited Annually on Average</dt>
                  <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">72</dd>
                </div>
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                  <dt class="text-base leading-7 text-gray-600">Largest Privately Held Company in San Diego</dt>
