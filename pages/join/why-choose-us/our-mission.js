            ...
            <div className="lg:flex lg:gap-5">
              <div className="max-w-prose">
                ...
                <p className="my-6 text-lg">
                  ...
                  Financial Services company committed to the support, success
                  and independence of our financial advisors and their clients.
                  We provide personalized service, common sense compliance and
                  access to high quality products, technology and practice
                  management solutions. We actively encourage an environment
                  that balances business and family; where employees are valued,
                  provided quality benefits and a supportive work environment
          ...
          <Container>
            <div className="lg:grid lg:grid-cols-2 lg:gap-5">
              <div className="self-center">
                ...
                <p className="my-6 text-lg">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Inventore alias nemo nulla nam. Vel recusandae saepe a
                  veritatis quo. Laudantium aspernatur recusandae, facilis
                  blanditiis accusantium impedit reiciendis eos cum hic corporis
                  voluptatem dolore est, vitae repellendus ipsa nostrum itaque
                  perferendis dignissimos. A ab iure vel odit, voluptatum eaque
