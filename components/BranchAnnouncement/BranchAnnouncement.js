...
const BranchAnnouncement = ({ newBranches }) => {
    ...
    return (
        <motion.div
            ...
            className='text-seabreeze-500 h-[500px] relative bg-[url("/home/surfer-ifg-drone-compressed.jpg")] bg-bottom rounded-[40px]'>
            <div className="bg-blue-wave-700/60 rounded-[40px] py-8 px-4 sm:py-16 lg:px-6 h-full">
                <div className='text-center absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                    ...
                    <p className='font-semibold text-lg lg:text-xl my-4'>{newBranches[0].reps} with {newBranches[0].dba} from {newBranches[0].officeLocation}</p>
