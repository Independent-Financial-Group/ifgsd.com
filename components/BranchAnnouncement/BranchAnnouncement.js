    ...
    <div className="bg-blue-wave-700/10 text-seabreeze-500 h-[500px] relative overflow-hidden rounded-[40px]">
      <div className="bg-blue-wave-700/60 rounded-[40px] py-8 px-4 sm:py-16 lg:px-6 h-full">
        ...
        <div className="text-center absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
          <h2 className="text-4xl lg:text-7xl font-bold uppercase">
            IFG Welcomes
          </h2>
          <p className="font-semibold text-lg lg:text-xl my-4">
            {`${fields.repNames[0]} ${fields.repNames[1]}`} with {fields.dba}{" "}
            from {fields.officeLocation}
          </p>
          <Link
            className="font-bold bg-neon-orange-500 py-2 px-4 rounded-lg"
            href="#"
          >
            Read More
          </Link>
