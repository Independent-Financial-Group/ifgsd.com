                ...
                <div className='absolute top-[50%] translate-y-[-50%]'>
                    <div className="mb-4 sm:flex sm:justify-center md:justify-start">
                        <div className="rounded-full px-3 py-1 text-sm leading-6 text-seabreeze-100 drop-shadow-xl bg-neon-orange-500 font-semibold">
                            ...
                            <Link href={`/press-and-media/press-releases/${content.reference.fields.slug}`} className="font-bold text-neon-orange-700/50 ml-4">
                    ...
                    >
                        ...
                        <p className="mt-6 text-xl text-seabreeze-500">{content.paragraph}</p>
                        <div className="mt-10 flex items-center gap-x-6">
                            ...
                            <a href="/about/our-story" className="text-md font-semibold leading-6 text-neon-orange-500">
