...
const Hero = ({ content }) => {
  return (
    <header className="relative bg-[url('/home/ifg-hero-surfer-wave-flipped-compressed.jpg')] bg-no-repeat bg-cover bg-center min-h-[calc(75vh-60px)] md:min-h-[calc(75vh-60px)] lg:min-h-[calc(90vh-60px)] xl:min-h-[calc(70vh-60px)] rounded-bl-[40px] rounded-br-[40px]">
          ...
          <div className="mb-4 sm:flex sm:justify-center md:justify-start">
            <div className="rounded-full px-3 py-1 text-sm leading-6 text-seabreeze-100 drop-shadow-xl bg-neon-orange-500 font-semibold">
              ...
              <Link
                ...
                className="font-bold text-neon-orange-700/50 ml-4"
              >
