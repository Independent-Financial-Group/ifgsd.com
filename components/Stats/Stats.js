...
const Stats = ({ content }) => {
  return (
    <>
      <p className="text-4xl lg:text-[80px] text-[#E2E7EB] font-bold lg:absolute lg:z-0 lg:bottom-80">
        integrity. balance.
      </p>
      <p className="text-4xl mb-16 lg:mb-0 lg:text-[80px] text-[#E2E7EB] font-bold lg:absolute lg:z-0 lg:bottom-64">
        independence.
      </p>
      <div className="lg:flex lg:gap-x-4">
        <div className="lg:max-w-prose">
          ...
          <Link
            className="font-bold bg-neon-orange-500 py-2 px-4 rounded-lg text-seabreeze-500"
      ...
      <div className="lg:mt-60">
        <h2 className="text-center lg:text-left text-4xl font-bold text-hazard-blue-500 py-8 lg:py-0">
          Rankings
        </h2>
