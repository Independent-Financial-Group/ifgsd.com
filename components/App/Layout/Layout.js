...
const navigation = [
  { name: "Dashboard", href: "#", icon: HomeIcon, current: true },
  {
    ...
    current: false,
    children: [
      { name: "Advisory", links: [{ name: "overview", href: "#" }] },
      { name: "Alternative Investments", href: "#" },
      { name: "Annuities", href: "#" },
      { name: "compliance", href: "#" },
      { name: "Insurance", href: "#" },
      { name: "Annuities", href: "#" },
      { name: "Operations", href: "#" },
      { name: "Practice Development", href: "#" },
      { name: "Retirement Services", href: "#" },
      { name: "Supervision", href: "#" },
    ],
  },
  {
    name: "Projects",
      ...
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
            <div className="flex h-16 shrink-0 items-center">
              <Image className="h-8 w-auto" src={logoIcon} alt="Your Company" />
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                          ...
                          <Disclosure as="div">
                            {({ open }) => (
                              <>
                                ...
                                <Disclosure as="ul" className="mt-1 px-2">
                                  {item.link.map((subItem) => (
                                    <li key={subItem.name}>
                                      ...
                                      <Disclosure.Panel>sub</Disclosure.Panel>
                                    </li>
                                  ))}
                                </Disclosure>
                              </>
