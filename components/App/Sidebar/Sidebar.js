        ...
        <div className="flex max-w-[20%] h-screen flex-col justify-between border-e bg-white">
            ...
            <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
                <div href="#" className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
                    ...
                    /> */}
                    <UserButton userProfileMode='navigation' userProfileUrl='/app/account' afterSignOutUrl='/'/>

                    <div>
                        <p className="text-xs">
                            <strong className="block font-medium">{userInfo.firstName + ' ' + userInfo.lastName}</strong>
