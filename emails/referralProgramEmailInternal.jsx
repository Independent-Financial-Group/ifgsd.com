...
export default function referralProgramEmailInternal({
  formData = {
    firstName: "N/A",
    lastName: "N/A",
    phone: "N/A",
  ...
  return (
    <Html>
      <Head />
      <Preview>The referral program form has been submitted.</Preview>
      <Tailwind>
          ...
          >
            ...
            <Section className="px-4">
              <Row>
                ...
                <Text style={text}>
                  The referral form on the website has been filled and submitted
              ...
              <Row>
                ...
                <Text style={text}>
                  <span className="font-semibold">Name</span>:{" "}
                  {formData.advisorFirstName} {formData.advisorLastName}
                </Text>
                <Text style={text}>
